...
RustUse/use-optics is intentionally small and focused. Contributions should keep the public API explicit, typed, and pragmatic.
...
- `use-optics` is the RustUse optics primitives crate, not a CLI and not a general automation layer.
